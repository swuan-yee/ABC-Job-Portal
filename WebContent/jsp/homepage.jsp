        ...
        <div class="row mt-1">
            ...
            <div class="col-md-4">
                <div class="p-card bg-white p-2 rounded px-3">
                    ...
                    <p>$1000</p><span class="d-block mb-5">Super Seven Stars Co.,Ltd | Yangon</span>
                    <a href="">View More</a>
                    <div class="d-flex justify-content-between stats">
            ...
            <div class="col-md-4">
                <div class="p-card bg-white p-2 rounded px-3">
                    ...
                    <p>MMK 6,000,000 - 8,000,000</p><span class="d-block mb-5">Gold Yacht Company Limited | Yangon
                    </span>
                    <a href="">View More</a>
                    <div class="d-flex justify-content-between stats">
